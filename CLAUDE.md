...
- `core/router.py` — Slash command parsing (`/status`, `/cancel`, `/new`, `/clear`, etc.) vs task creation. Supports custom slash commands from agent profile. Scheduling is handled by Claude Code's scheduler MCP plugin (natural language).
